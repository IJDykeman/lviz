...
std::string WHITESPACE_STR = "(?:\\s|\\r)+";
std::string WHITESPACE_OPT_STR = "(?:\\s)*";
...
std::regex LINE_REGEX("^line" + WHITESPACE_STR + VEC3_STR + WHITESPACE_STR + COLOR + WHITESPACE_STR + VEC3_STR +
                          WHITESPACE_STR + COLOR + WHITESPACE_OPT_STR + "$",
                      std::regex::optimize);

std::regex NEW_FRAME_REGEX("new_frame" + WHITESPACE_OPT_STR, std::regex::optimize);
std::regex SET_FRAME_TIME_REGEX("set_frame_time" + WHITESPACE_STR + "(" + FLOAT_STR + ")" + WHITESPACE_OPT_STR, std::regex::optimize);
